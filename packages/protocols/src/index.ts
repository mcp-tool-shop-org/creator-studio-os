...
import { ProjectV2Schema, type ProjectV2 } from "@creator-studio-os/core";
...
export type { ReplayManifest, ProtocolStep };
import { brandDeckMinimal, STEP_NAMES } from "./brand-deck-minimal.js";
export { STEP_NAMES };
